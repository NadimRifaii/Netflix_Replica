            ...
            <div className="watch-join">
                <div className="watch-container">
                    <div className="logo-content">
                        <span className="logo"><svg className="value-prop-logo" focusable="false" viewBox="225 0 552 1000"
                            aria-hidden="true" data-uia="n-logo"><defs><   radialGradient id="9f8d7ad6-602a-4a28-81a3-f2fc8f97e556-a"
                                r="75%" gradientTransform="matrix(.38 0 .5785 1 .02 0)"><stop offset="60%" stopOpacity=".3"></stop><stop
                                    offset="90%" stopOpacity=".05"></stop><stop offset="100%" stopOpacity="0"></stop></radialGradient></defs><path
